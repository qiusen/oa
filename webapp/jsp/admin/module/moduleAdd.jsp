...
<body>
<form name="moduleForm" id="moduleForm" method="post" action="moduleAction!addSave.${actionExt}" onsubmit="return checkForm();">
<table cellpadding="0" cellspacing="0" class="l-table-edit" style="margin-top:50px;margin-left:50px;">
    <tr>
        <td align="right" class="l-table-edit-td">模块名称：</td>
        <td align="left" class="l-table-edit-td"><input name="module.modulename" type="text" id="module.modulename" ltype="text" /></td>
        <td align="left"><font color="red">*</font></td>
    </tr>
    <tr>
        <td align="right" class="l-table-edit-td">模块URL：</td>
        <td align="left" class="l-table-edit-td"><input name="module.moduleurl" type="text" id="module.moduleurl" ltype="text" /></td>
        <td align="left"><font color="red">*</font></td>
    </tr>
    <tr>
        <td align="right" class="l-table-edit-td">模块Action：</td>
        <td align="left" class="l-table-edit-td"><input name="module.moduleact" type="text" id="module.moduleact" ltype="text" /></td>
        <td align="left"><font color="red">*</font></td>
    </tr>
    <tr>
