...
<table cellpadding="0" cellspacing="0" class="l-table-edit" style="margin-top:50px;margin-left:50px;">
    ...
    <tr>
    	...
    	<td align="left" class="l-table-edit-td"><input name="managerRole.roleId" type="text" id="managerRole.roleId" ltype="text" /></td>
    	<td align="left"></td>
    </tr>
    <tr>
    	<td align="right" class="l-table-edit-td">创建时间：</td>
    	<td align="left" class="l-table-edit-td"><input name="managerRole.createtime" type="text" id="managerRole.createtime" ltype="text" /></td>
    	<td align="left"></td>
    </tr>
    <tr>
    	<td align="right" class="l-table-edit-td">修改时间：</td>
    	<td align="left" class="l-table-edit-td"><input name="managerRole.updatetime" type="text" id="managerRole.updatetime" ltype="text" /></td>
    	<td align="left"></td>
    </tr>
    <tr>
