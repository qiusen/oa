...
<body>
<form name="managerRoleForm" id="managerRoleForm" method="post" action="managerRoleAction!editSave.${actionExt}" onsubmit="return checkForm();">
<table cellpadding="0" cellspacing="0" class="l-table-edit" style="margin-top:50px;margin-left:50px;">
    <input type="hidden" id="managerRole.id" name="managerRole.id" value="${requestScope.managerRole.id}"/>
    <tr>
        <td align="right" class="l-table-edit-td">邮箱：</td>
        <td align="left" class="l-table-edit-td"><input name="managerRole.email" type="text" id="managerRole.email" ltype="text" value="${requestScope.managerRole.email}"/></td>
        <td align="left"></td>
    </tr>
    <tr>
